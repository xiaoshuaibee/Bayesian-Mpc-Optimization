function error = calculate_error2(gain, theta_const, theta_delay, control_inputs)
    % 模型参数（电采暖系统）
    ...
    try
        ...
        control_change_penalty_weight = 3.0;  % 控制变化率惩罚项的权重系数
        control_value_penalty_weight = 3;  % 控制信号绝对值惩罚项的权重系数
        large_change_penalty_weight = 5.0;  % 过大变化惩罚项的权重系数
        temp_rate_of_change_penalty_weight = 5;  % 温度变化速率惩罚项的权重系数
